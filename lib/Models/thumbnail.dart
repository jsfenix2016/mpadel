...
class Thumbnail {
  ...
  Thumbnail convertThumbnailBDToThumbnail(ThumbnailBD thumbnailBD) {
    return Thumbnail(
      timeMs: thumbnailBD.timeMs.toString(),
      imageUrl: thumbnailBD.imageUrl,
      titleThumb: thumbnailBD.titleThumb,
      descriptionThumb: thumbnailBD.descriptionThumb,
      timeCapture: thumbnailBD.timeCapture.toIso8601String(),
      timeDurationRecoded: thumbnailBD.timeDurationRecoded,
      titleRecoded: thumbnailBD.titleRecoded,
      pathRecoded: thumbnailBD.recoderPath ?? '',
    );
  }
}
