...
import 'package:Klasspadel/Page/VideoEditPlayer/Controller/edit_controller.dart';
...
class _VideoEditPlayerScreenState extends State<VideoEditPlayerScreen> {
  final EditController edtiVC = Get.put(EditController());
...
class _VideoEditPlayerWidgetState extends State<VideoEditPlayerWidget> {
  ...
  final EditController edtiVC = Get.find<EditController>();
  bool isExpand = false;
                                              ...
                                              onPressed: () async {
                                                if (_handPreference !=
                                                  ...
                                                  var bytes = await controller
                                                      .capture();
                                                  var save = await GallerySaver
                                                      .saveVideo(
                                                          widget.item.urlVideo);
                                                  List<ThumbnailBD>
                                                      listThumbBD = listThumb
                                                          .map(
                                                              (thumbnail) =>
                                                                  ThumbnailBD(
                                                                    timeMs: int.parse(
                                                          ...
                                                          .toList();
                                                  VideoBD videoTemp = VideoBD(
                                                    urlVideo: widget
                                                        .videoPlayerController
                                                        .dataSource,
                                                    title: "Corrección",
                                                    descriptionVideo:
                                                        "$_handPreference - Correcciones ",
